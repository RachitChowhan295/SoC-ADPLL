...
module dtc_model #(
    ...
    parameter PHASE_BITS = 13,
    parameter PHASE_FULL_SCALE = 6400 
...
always @(*) begin
    ...
    if (F_mod != 0) begin
        temp_code = ((m1_reg * MAX_CODE) + (F_mod >> 1)) / F_mod;
        ...
        //phase_fract = $signed({20'd0, dtc_code_next}) <<< 2;  // multiply by 4, exact shift
        phase_fract = (dtc_code_next * PHASE_FULL_SCALE + (MAX_CODE >> 1)) / MAX_CODE;
