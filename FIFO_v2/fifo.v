...
module fifo #(
    ...
    // ------------------------------------------------------------------------
    // POINTERS & GRAY CODE LOGIC 
    // ------------------------------------------------------------------------
    reg [ADDR_WIDTH:0] wr_ptr_bin, wr_ptr_gray;
    reg [ADDR_WIDTH:0] rd_ptr_bin, rd_ptr_gray;

    //Reset synchronizers variables
    reg wr_rst_sync1, wr_rst_sync2;
    reg rd_rst_sync1, rd_rst_sync2;
    ...
    always @(posedge wr_clk or posedge wr_rst_sync2) begin
    ...
    always @(posedge rd_clk or posedge rd_rst_sync2) begin
