...
module adpll_top #(
   ...
   // N_avg = N_int + K_mod/F_mod, in Q16.16
    ...
    wire signed [31:0] dyn_preload  = preload_calc[31:0];
...
// m1_reg, F_mod and c2_prev will be connected from MASH module
    ...
    gain_scheduler #(
        ...
        .clk(ref_clk),                   // Changed from clk
        .rst(rst),
        .phase_error(phase_residual),    // Changed from phase_error (using 25-bit DTC output)
    ...
    pi_loop_filter #(
        ...
        .clk(ref_clk),                   // Changed from clk
        .rst(rst),
        .enable(do_update),              // Changed from enable (driven by CIC update rate)
        .error(phase_residual),
        .preload(dyn_preload),          // Changed from phase_error
